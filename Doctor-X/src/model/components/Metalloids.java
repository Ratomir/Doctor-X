 ...
 *
 */
public class Metalloids extends AtomComponent {

	public Metalloids(Point p, int r, Color color, int number, String sign, String name, int [] numberOfRings, float weight, AtomType type)
	{
